...
export class ModalComponent implements AfterViewChecked {
  ...
  preMinimizeRootWidth: number;     //

  preMinimizeRootHeight: number;    //

  preMinimizeBodyHeight: number;    //

  preMinimizePageX: number;         //

  preMinimizePageY: number;         //
  ...
  minimize() {
    ...
    this.modalRoot.nativeElement.style.top = 'auto';

    this.modalRoot.nativeElement.style.bottom = '35px';

    this.modalRoot.nativeElement.style.left = '0px';

    this.modalRoot.nativeElement.style.width = '0px';

    this.modalRoot.nativeElement.style.height = '0px';


    this.modalBody.nativeElement.style.height = '0px';
  ...
  revertMinimize() {
    ...
    this.modalRoot.nativeElement.style.bottom = null;
